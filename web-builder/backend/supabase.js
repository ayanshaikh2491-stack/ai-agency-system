 ...
 */
export const uploadImage = async (file, clientId, fileName = null) => {
  try {
...
/**
 * Set client ID for RLS policies (to be called in app initialization)
 * @param {string} clientId - The client ID to set
 */
export const setClientId = (clientId) => {
  // This would typically be done via Supabase function or by setting a custom claim
  // For now, we'll rely on passing client_id in queries
